            ...
            <div class="container m-auto px-6">
                ...
                <div class="lg:flex justify-between items-center">
                    <div class="lg:w-6/12 lg:p-0 p-7">
                        <h1 class="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl "> Welcome to our Coworking Space
                            Community! </h1>
                        
                            <p class="mt-3 text-gray-500">METEOR was founded with a simple yet powerful idea: to provide a space where professionals, freelancers, startups, and established businesses can work, connect, and grow together. We understand the challenges of modern work-life, and we are here to bridge the gap between productivity and community, offering a seamless blend of work and play.</p>

                            <p class="mt-3 text-gray-500">At METEOR, we believe that work should never be just about a place; it's about
                            the people, the ideas, and the connections that fuel your passion and drive your success. We are
                            more than just a coworking space; we are a vibrant community of like-minded individuals,
                            entrepreneurs, and innovators, coming together to create, collaborate, and thrive.</p>

                        <div class="py-5">
                            <a href="#"
                                class="text-white rounded-md py-2 px-5 text-lg font-semibold bg-amber-600 inline-block border border-amber-600 mr-3">Join
                                the community</a>
                            <a href="#"
                                class="text-black rounded-md py-2 px-5 text-lg font-semibold bg-gray-400 inline-block border hover:bg-white hover:text-black">Request
                                a tour</a>
                        </div>
            ...
            <div class="container px-6 py-10 mx-auto">
                <div class="lg:flex lg:items-center">
                    <div class="w-full space-y-12 lg:w-1/2 ">
                        <div>
                            <h1 class="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl ">Co-working Where You Can<br/> Count on Each Other</h1>
                        ...
                        <div class="md:flex md:items-start md:-mx-4">
                            <span class="inline-block p-2 text-amber-500 bg-amber-100 rounded-xl md:mx-4">
                            ...
                            <div class="mt-4 md:mx-4 md:mt-0">
                                <h1 class="text-xl font-semibold text-gray-700 capitalize">Our Mission</h1>

                                <p class="mt-3 text-gray-500 ">
                                    Our mission is to be the catalyst for your success. We provide the infrastructure, the support, and the inspiration you need to turn your vision into reality. Whether you're a solopreneur, a startup founder, or part of a growing team.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="md:flex md:items-start md:-mx-4">
                            ...
                            <div class="mt-4 md:mx-4 md:mt-0">
                                <h1 class="text-xl font-semibold text-gray-700 capitalize ">Our Amenities</h1>

                                <p class="mt-3 text-gray-500 ">
                                    We understand that success is not just about work; it's about a balanced lifestyle. That's why we offer a range of amenities to make your workday more enjoyable. From complimentary gourmet coffee and healthy snacks to relaxation zones and wellness programs, we've got you covered.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="md:flex md:items-start md:-mx-4">
                            ...
                            <div class="mt-4 md:mx-4 md:mt-0">
                                <h1 class="text-xl font-semibold text-gray-700 capitalize ">Our Community</h1>

                                <p class="mt-3 text-gray-500 ">
                                    At METEOR, our community is the heartbeat of our space. Join a diverse network of professionals from various industries, all driven by a shared passion for success and growth. From networking events to skill-building workshops, we curate experiences that foster meaningful connections and spark collaboration.
                                </p>
                            </div>
                        </div>
                    </div>
