<template>
    <div class="min-h-screen flex justify-center items-center">
      ...
      <h1 class="text-sm">
        <span class="text-orange-600 tracking-wide">OUR PLANS</span>
      </h1>
      <p class="pt-6 text-4xl font-normal w-full md:w-full">
        Choose a plan that works<br/> best for you and <br/>your team
      </p>
    </div>
            <div class="pt-24 flex flex-row">
                ...
                <div class="w-96 p-8 bg-white text-center rounded-3xl pr-16 shadow-xl">
                    ...
                    <div class="pt-8">
                        ...
                        <a href="#" class="">
                            <p class="w-full py-4 bg-amber-600 mt-8 rounded-xl text-white">
                ...
                <div class="w-80 p-8 bg-gray-900 text-center rounded-3xl text-white border-4 shadow-xl border-white transform scale-125">
                    ...
                    <div class="absolute top-4 right-4">
                        <p class="bg-amber-700 font-semibold px-4 py-1 rounded-full uppercase text-xs">Popular</p>
                    </div>
                </div>
                <!-- Enterprise Card -->
